...
def calc_7_simul_and_print(cl):
    ...
    print(cl.back_state)
    print('=' * 100)
    m1, m2, m3, m4 = cl.get_7_simul_flip_bpaul_1_x2()
    print('[7-Simul Flip] Bpaul’s Order 1 (x2 encoding)        : {}, {}, {}, {}'.format(m1, m2, m3, m4))
    m1, m2, m3, m4 = cl.get_7_simul_flip_bpaul_2_x2()
    print('[7-Simul Flip] Bpaul’s Order 2 (x2 encoding)        : {}, {}, {}, {}'.format(m1, m2, m3, m4))
    print('-' * 100)
    ...
    print('-' * 100)
    m1, m2, m3, m4, m5 = cl.get_7_simul_no_flip_bpaul_x2()
    print('[7-Simul No-Flip] Bpaul’s Order (x2 encoding)       : {}, {}, {}, {}, {}'.format(m1, m2, m3, m4, m5))
    m1, m2, m3, m4, m5 = cl.get_7_simul_no_flip_bpaul_y2()
